               ...
               <div class="row">
                  ...
                  <div class="col-md-12">
                     ...
                     <div action="" class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <legend><center><h2>Formulario de registro de Empleados</h2></center></legend>
                           <div class="panel-heading">
                           ...
                           <fieldset>
                              <div class="form-group">
                                 <div class="col-sm-4">
                                    <!--  <?php echo $this->session->userdata('idEmpleado') ?>-->
                                 </div>
                                 
                                 <div class="col-sm-4">

                                    <?php
                                    echo form_open_multipart('usuarios/validarciP');
                                    ?>
                                    <label for="formGroupExampleInput">Carnet de Identidad:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>

                                    <input type="text" class="form-control bg-light" id="formGroupExampleInput" name="ci" placeholder="Ingresar el carnet de identidad" minlength="7" maxlength="10"  onkeypress="return soloNumeros(event)" required>
                                    
                                    
                                    <?php 
                                    switch ($msgE) {
                                       case '1':
                                       echo "<div data-toggle='notify' data-onload data-message='<h3>Carnet ingresado correctamente</h3>'
                                       data-options='{&quot;status&quot;:&quot;success&quot;, &quot;pos&quot;:&quot;top-center&quot;}' class='hidden-xs'></div>";
                                       break;
                                       case '2':
                                       echo "<div data-toggle='notify' data-onload data-message='<h3>El carnet ya existe. Verifique!</h3>'
                                       data-options='{&quot;status&quot;:&quot;danger&quot;, &quot;pos&quot;:&quot;top-center&quot;}' class='hidden-xs'></div>";
                                       break;
                                       default:
                                       echo "<div data-toggle='notify' data-onload data-message='<h3>Ingreso correcto</h3>'
                                       data-options='{&quot;status&quot;:&quot;info&quot;, &quot;pos&quot;:&quot;top-center&quot;}' class='hidden-xs'></div>";
                                       break;
                                    }
                                    ?>
                                 </div> 
                                 ...
                                 <div class="col-sm-4">
                                    <input type="text" name="idUsuario"  value="<?php echo $this->session->userdata('idEmpleado') ?>">
                           ...
                           <fieldset>
                              <div class="form-group">
                                 <div class="col-sm-4"> 
                                  ...
                                  <select class="form-control bg-light" id="exampleFormControlSelect1" name="cargo" required>
                        ...
                        <fieldset>
                           <div class="form-row">
                              <div class="col-sm-4">
                                 ...
                                 <input type="text" class="form-control bg-light" name="apellidoPaterno" placeholder="Ingrese el Apellido paterno" maxlength="20" onkeypress="return soloLetras(event)" required>
                              </div>
                              <div class="col-sm-4">
                                 <label for="formGroupExampleInput">Apellidos Materno:</label>
                                 <input type="text" class="form-control bg-light" name="apellidoMaterno" placeholder="Ingrese el Apellido materno" maxlength="20" onkeypress="return soloLetras(event)" required>
                              </div>
                              <div class="col-sm-4">
                                 <label for="formGroupExampleInput">Nombres:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                 <input type="text" class="form-control bg-light" name="nombres" placeholder="Ingrese sus nombres" maxlength="30" onkeypress="return soloLetras(event)" required>
                              </div>
                           </div> 
                        </fieldset>  
                        <br>
                        <fieldset>
                           <div class="form-row">
                              <div class="col-sm-3">
                                 ...
                                 <select class="form-control bg-light" id="exampleFormControlSelect1" name="sexo" required>
                              ...
                              <div class="col-sm-3">
                                 ...
                                 <input class="form-control bg-light" type="date" value="19" id="example-date-input" name="fechaNacimiento">
                              </div>
                              <div class="col-sm-6">
                                 <label for="formGroupExampleInput">Dirección:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                 <input type="text" class="form-control bg-light" name="direccion" placeholder="Ingrese la direccion" maxlength="70">
                              </div>
                           </div>
                        </fieldset>
                        <fieldset>
                           <div class="form-row">
                              <div class="col-sm-5">
                                 ...
                                 <input type="text" class="form-control bg-light" name="celular" placeholder="Ingrese su celular o telefono" maxlength="15" onkeypress="return soloNumeros(event)" required>
                              </div>
                              <div class="col-sm-7">
                                 <label for="exampleInputEmail1">Correo Electrónico:</label>
                                    ...
                                    <input type="text" class="form-control bg-light" name="correo" placeholder="Ingrese su correo electronico" maxlength="35">
                              ...
                              <fieldset>
                                 <div class="form-row">
                                    <div class="col-sm-6">
                                       <label for="formGroupExampleInput">Nombre de usuario:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>


                                       <input type="text" class="form-control bg-light" name="login" placeholder="Ingrese su nombre de usuario" maxlength="15" required>

                                    </div>
                                    <div class="col-sm-6">
                                       <label for="exampleInputPassword1">Contraseña:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>

                                       <input type="password" class="form-control bg-light" id="exampleInputPassword1" name="password" placeholder="Ingrese su contraseña" maxlength="20" required>
                              ...
                              <button type="submit" class="btn btn-success btn-lg btn-block">Registrar Empleado</button>
                              <?php
                              echo form_close();
                              ?>
                           </div>
