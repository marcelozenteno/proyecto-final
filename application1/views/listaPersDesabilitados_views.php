            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="panel panel-default">
                     <center><legend><h2>Listado de empleados inhactivos</h2></legend></center>
                                 ...
                                 foreach ($personal->result() as $row)
                                 {
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <?php
                                          $atributos = array('class' => 'form-group' );
                                          echo form_open_multipart('usuarios/habilitar',$atributos); ?>
                                          <input type="hidden" name="id" value="<?php echo $row->idPersona; ?>">
                                          <button type="submit" class="btn btn-danger btn">Habilitar</button>
                                          <?php echo form_close(); ?>
                                       </td>
                                    </tr>
                                    <?php    
                     ...
                     <tr>
                        ...
                        <th>
                           ...
                           <div class="form-group">
                              <a href="<?php echo base_url(); ?>index.php/usuarios/formPersonal" title="Extended" data-toggle="" class="no-submenu"><span class="item-text"></span><button type="submit" class="btn btn-success btn">Agregar Empleado</button>
                              </a>
                        ...
                        <th>
                           ...
                           <button type="submit" class="btn btn-success btn">Empleados habilitados</button>
                           <?php echo form_close(); ?>
                        </th>
                     </tr>
                  </thead>
