                 ...
                 <!-- <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget">
                           <div class="panel-body">
                              ...
                              <h3 class="mt0">120</h3>
                              <p class="text-muted">Socios de la Linea</p>
                              <div class="progress progress-striped progress-xs">
                                 <div role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="40" style="width: 80%;" class="progress-bar progress-bar-success">
                     ...
                     <div class="col-md-4">
                        ...
                        <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget">
                           <div class="panel-body">
                              ...
                              <h3 class="mt0">20</h3>
                              <p class="text-muted">Personal de la Linea</p>
                              <div class="progress progress-striped progress-xs">
                                 <div role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="10" style="width: 80%;" class="progress-bar progress-bar-info">
                                    <span class="sr-only">80% Complete</span>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="col-md-4">
                        ...
                        <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget">
                           <div class="panel-body">
                              ...
                              <h3 class="mt0">120</h3>
                              <p class="text-muted">Vehiculos</p>
                              <div class="progress progress-striped progress-xs">
                                 <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 90%;" class="progress-bar progress-bar-warning">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <!-- START panel-->
                        <div class="panel panel-default">
                           <div class="panel-heading">Tareas Pendientes
                           ...
                           <div class="table-responsive">
                              <table class="table table-striped table-bordered table-hover">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td>Impresion de hojas de ruta para los socios</td>
                                       <td>
                                          <div class="progress progress-striped progress-xs">
                                             <div role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 10%;" class="progress-bar progress-bar-success">
                                                <span class="sr-only">10% Complete</span>
                                             </div>
                                          </div>
                                       </td>
                                       <td>
                                          <em class="fa fa-calendar fa-fw text-muted"></em>05/10/2020</td>
                                       ...
                                       <tr>
                                          <td>Mantenimiento de equipos de oficina.</td>
                                          <td>
                                             <div class="progress progress-striped progress-xs">
                                          ...
                                          <td>
                                             <em class="fa fa-calendar fa-fw text-muted"></em>10/11/2020</td>
                                             <td class="text-center">
                                                <div class="btn-group"><a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cog"></i></a>
                                                 <ul class="dropdown-menu pull-right text-left">
                                                   <li><a href="#">Ver</a>
                                       ...
                                       <tr>
                                          <td>Pago de sueldos a personal</td>
                                          <td>
                                             <div class="progress progress-striped progress-xs">
                                          ...
                                          <td>
                                             <em class="fa fa-calendar fa-fw text-muted"></em>05/09/2020</td>
                                             <td class="text-center">
                                                <div class="btn-group"><a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cog"></i></a>
                                                 <ul class="dropdown-menu pull-right text-left">
                                                   <li><a href="#">Ver</a>
