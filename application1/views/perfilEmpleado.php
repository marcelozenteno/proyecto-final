                  ...
                  <div class="col-lg-6">
                     ...
                     <div class="panel widget">
                        <div class="panel-body">
                           <div href="<?php echo base_url(); ?>47admin/#" class="media p mt0">
                              <div class="pull-left">
                                 <img src="<?php echo base_url() ?>uploads/<?php echo $row->foto; ?>" style="width: 200px; height: 200px;" alt="Image" class="media-object img-circle">
                              </div>
                                    ...
                                    <ul class="list-unstyled">
                                       <li class="mb-sm">
                                          ...
                                          <li class="mb-sm">
                                             ...
                                             <li class="mb-sm">
                                                <em class="fa fa-envelope fa-fw"></em><?php echo $row->correo; ?></li>
                                             </ul>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="panel-body bg-inverse" style="background-color:#021C1E;">
                                    <center><h3>Observaciones del mes</h3> </center>
                                    <br><br> 
                                    <div class="row row-table text-center">
                                       <div class="col-xs-4">
                                          <p class="m0 h3">15</p>
                                          <p class="m0 text-muted">Asistencia</p>
                                       </div>
                                       <div class="col-xs-4">
                                          <p class="m0 h3">5</p>
                                          <p class="m0 text-muted">Atrasos</p>
                                       </div>
                                       <div class="col-xs-4">
                                          <p class="m0 h3">3</p>
                                          <p class="m0 text-muted">Faltas</p>
                                       </div>
                                       <div class="col-xs-4">
                                          <p class="m0 h3">2</p>
                                          <p class="m0 text-muted">Permisos</p>
                                       </div>
                                    </div>
                                    <br>
                                    <br>
                           ...
                           <div class="col-lg-6">
                              ...
                              <div class="panel widget">
                               ...
                               <form method="post" action="<?php echo 'modificarPassword' ?>" >
                                 <!-- START panel-->
                                       ...
                                       <fieldset>
                                          <div class="form-row">
                                             <div class="col-sm-6">
                                                ...
                                                <input class="form-control" id="formGroupExampleInput" type="password" name="password" required>
                                             </div>
                                             <div class="col-sm-6">
                                       ...
                                       <fieldset>
                                         ...
                                         <div class="form-row">
                                          <div class="col-sm-6">
                                             ...
                                             <input type="password" id="psw" name="nuevopassword" class="form-control" required>
                                          </div>
                                          <div class="col-sm-6">
                                             <label class="control-label">Confirmar contraseña: *</label>
                                             <input type="password" id="cpsw" class="form-control" required>
                                           <div id="mostrarError"></div></div>
                                       </div>
                                    </fieldset>
                                    
                                    <div class="required"><center>* Campos requeridos</center></div>
                                 </div>

                                 <div class="panel-footer" style="background-color:#021C1E;">
                                    <center>
                                       <button type="submit" class="btn btn-primary" style="background-color:#2C7873">Actualizar datos</button>
                                    </center>   
                                 </div>
...
<!-- <button type="button" data-toggle="notify" data-message="&lt;em class='fa fa-check'&gt;&lt;/em&gt; Message with icon.." class="btn btn-default">Message with Icon</button> -->
 ...
 switch ($msgC) {
   case '1':
   echo "<div data-toggle='notify' data-onload data-message='<h3>Contraseña incorrecta</h3>'
 data-options='{&quot;status&quot;:&quot;danger&quot;, &quot;pos&quot;:&quot;top-center&quot;}' class='hidden-xs'></div>";
   break;
   case '2':
   echo "<div data-toggle='notify' data-onload data-message='<h3>Contraseña modificada exitosamente</h3>'
...
?>
<div id="ModalContraseña" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
   <div class="modal-dialog modal-sm">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" data-dismiss="modal" aria-hidden="true" class="close">×</button>
            <center><h4 id="myModalLabel" class="modal-title" >Exitoso</h4></center>
            </div>
            <!-- <intype="hidden" name="id" id="txtid">put  -->
            <div class="modal-body">
              <center><img src="<?php echo base_url(); ?>uploads/exito.png" width="140" ><br><br>
                 <h3>Contraseña modificada exitosamente</h3></center>
              </div>
              <div class="modal-footer">
               <center><button type="button" data-dismiss="modal" class="btn btn-success">Aceptar</button></center>
               </div>
            </div>
         </div>
      </div>
