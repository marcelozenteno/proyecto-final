                  ...
                  <div class="col-md-12">
                     ...
                     <div action="" class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <?php
                           echo form_open_multipart('usuarios/agregarbdRuta');
                           ?>
                           <fieldset>
                              <div class="form-row">
                           ...
                           <fieldset>
                              <div class="form-group">
                                 <div class="col-sm-4">
                                    ...
                                    <label for="formGroupExampleInput">Nombre de la Ruta:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>

                                    <input type="text" class="form-control bg-light" id="formGroupExampleInput" name="nombre" placeholder="Ingresar el nombre de la ruta" minlength="7" maxlength="30" required>
                                 </div>

                                 <div class="col-sm-5">
                                    <label for="formGroupExampleInput">Descripcion:</label>

                                    <input type="text" class="form-control bg-light" id="formGroupExampleInput" name="descripcion" placeholder="Ingresar alguna descripcion en caso de ser necesaria" minlength="0" maxlength="100" >
                                 </div>

                                 <div class="col-sm-3">
                                    <label for="exampleFormControlSelect1">Sentido de la ruta:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                    <select class="form-control bg-light" id="exampleFormControlSelect1" name="idSentido" required>
