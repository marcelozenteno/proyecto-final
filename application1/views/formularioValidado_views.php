      ...
      <section>
         ...
         <section class="main-content">
            <h3>Formulario de registro
               <br>
               <small>Ingrese los datos personales del nuevo personal.</small>
            </h3>
            <!-- START row-->
             <!-- <div class="row">
               <div class="col-lg-6">
            ...
            <div class="row">
               ...
               echo form_open_multipart('usuarios/agregarbdP',$atributos);
               ?>
               <div class="col-md-12">
                     ...
                     <div action="" class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group">
                              <div class="col-sm-4"> 
                                 <input type="text" name="ci" value="<?php echo $this->session->userdata('ci') ?>" maxlength="25">
                              ...
                              <div class="col-sm-4">
                                 ...
                                 <input type="file" class="form-control bg-light" id="formGroupExampleInput" name="foto"  value="fichero">
                              </div>  
                           </div>
                           </fieldset>
                           <fieldset>
                           <div class="form-row">
                              <div class="col-sm-4">
                                 ...
                                 <input type="text" class="form-control bg-light" name="apellidoPaterno" placeholder="Ingrese el Apellido paterno" maxlength="25" required>
                              </div>
                              <div class="col-sm-4">
                                 <label for="formGroupExampleInput">Apellidos Materno:</label>
                                 <input type="text" class="form-control bg-light" name="apellidoMaterno" placeholder="Ingrese el Apellido materno" maxlength="25" required>
                              </div>
                              <div class="col-sm-4">
                                 <label for="formGroupExampleInput">Nombres:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                 <input type="text" class="form-control bg-light" name="nombres" placeholder="Ingrese sus nombres" maxlength="30" required>
                              </div>
                           </div> 
                           </fieldset>  
                           <br>
                           ...
                           <div class="form-row">
                              ...
                              <div class="col-sm-6">
                                 ...
                                 <input type="text" class="form-control bg-light" name="direccion" placeholder="Ingrese la direccion" maxlength="100">
                              </div>
                           </div>
                           </fieldset>
                           <fieldset>
                           <div class="form-row">
                              <div class="col-sm-5">
                                 ...
                                 <input type="text" class="form-control bg-light" name="celular" placeholder="Ingrese su celular o telefono" maxlength="10" required>
                              </div>
                              <div class="col-sm-7">
                                 <label for="exampleInputEmail1">Correo Electrónico:</label>
                                    ...
                                    <input type="text" class="form-control bg-light" name="correo" placeholder="Ingrese su correo electronico" maxlength="45">
                           ...
                           <div class="form-row">
                              <div class="col-sm-6">
                                 <label for="formGroupExampleInput">Nombre de usuario:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                    ...
                                    <input type="text" class="form-control bg-light" name="usuario" placeholder="Ingrese su nombre de usuario" required>
                                 
                              </div>
                              <div class="col-sm-6">
                                 <label for="exampleInputPassword1">Contraseña:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                 
                                    <input type="password" class="form-control bg-light" id="exampleInputPassword1" name="password" placeholder="Ingrese su contraseña" required>
                           ...
                           <hr/>
                                 ...
                                 <button type="submit" class="btn btn-info btn-lg btn-block">Registrar Personal</button>
