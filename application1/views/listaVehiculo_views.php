 ...
 <section class="wrapper">
   ...
   <nav role="navigation" class="navbar navbar-default navbar-top navbar-fixed-top">
      ...
      <div class="navbar-header" style="background-color:#2C7873">
         <a href="<?php echo base_url(); ?>index.php/usuarios/index" class="navbar-brand">
                              ...
                              <tbody>
                                 ...
                                 foreach ($vehiculo->result() as $row)
                                 {
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                         <!-- Contact avatar-->
                                         <img src="<?php echo base_url() ?>uploads/vehiculos/<?php echo $row->foto; ?>" style="width: 40px; height: 40px" alt="Image" class="media-object img-circle">
