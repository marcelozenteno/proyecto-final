            ...
            <div class="row">
               ...
               <div class="col-md-12">
                     ...
                     <div action="" class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <legend><center><h2>Formulario de registro de Socios</h2></center></legend>
                           <div class="panel-heading">
                              <div class="panel-title"><code>Campos obligatorios (*)</code></div>
                           </div>
                           <?php
                           echo form_open_multipart('usuarios/agregarbdS');
                           ?>
                           <fieldset>
                           <div class="form-group">
                              <div class="col-sm-3">
                              <input type="hidden" name="idUsuario" value="<?php echo $this->session->userdata('idEmpleado') ?>">
                              <label for="formGroupExampleInput">Carnet de Identidad:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                               ...
                               <div class="col-sm-3">
                                 <label for="formGroupExampleInput">Licencia:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                  
                                 <input type="text" class="form-control bg-light" id="formGroupExampleInput" name="licencia" placeholder="Ingresar el numero de licencia" minlength="7" maxlength="10" onkeypress="return soloNumeros(event)" required> 
                              </div> 

                              <div class="col-sm-2">
                                 <label for="exampleFormControlSelect1">Categoria:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                 <select class="form-control bg-light" id="exampleFormControlSelect1" name="categoria" required>
                           ...
                           <hr/>
                                 ...
                                 <button type="submit" class="btn btn-success btn-lg btn-block">Registrar Socio</button>
                             <?php
               echo form_close();
               ?>
                     </div>
               ...
               echo form_open_multipart('usuarios/listaSocio',$atributos);
