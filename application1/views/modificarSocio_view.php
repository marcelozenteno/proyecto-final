      ...
      <section>
         ...
         <section class="main-content">
            ...
            <div class="row">
               ...
               echo form_open_multipart('usuarios/modificarbdS',$atributos);
                     ...
                     <div action="" class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                 <label for="formGroupExampleInput">Nro de Licencia:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                 <input type="text" class="form-control bg-light" id="formGroupExampleInput" name="licencia" value="<?php echo $row->licencia; ?>"placeholder="Ingresar el numero de licencia" required>
                              </div>
                              <div class="col-sm-2">
                                 <label for="formGroupExampleInput">Categoria:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code>*</code></label>
                                 <select class="form-control bg-light" id="exampleFormControlSelect1" name="categoria" value="<?php echo $row->categoria; ?>" required>
                           ...
                           <hr/>
                           <button type="submit" class="btn btn-success btn-lg btn-block">Actualizar Socio</button>
